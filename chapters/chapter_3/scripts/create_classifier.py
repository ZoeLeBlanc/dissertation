...
time_df = pd.read_csv('../data/time_classifier_training_test.data.csv')
time_filename = '../data/time_classifier'
...
time_df['class_numb'] = 0
time_df.class_numb[time_df.classify =='early_time'] = '0'
time_df.class_numb[time_df.classify =='late_time'] = '1'
time_df.class_numb = time_df.class_numb.astype(int)
time_df.cleaned_spacy_text = time_df.cleaned_spacy_text.fillna('')
